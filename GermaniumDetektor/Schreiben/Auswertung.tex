...
Anhand der \ce{^{152}Eu} Quelle sollen die Kanäle des Germaniumdetektors auf Energien kalibriert werden.
Die Emissionsenergien von \ce{^{152}Eu} und die dazugehörigen Emissionswahrscheinlichen sind bekannt und in Tabelle \ref{tab:Eu_Emisionsenergie} aufgelistet \cite{Eu_Emision}.
...
\begin{table}[H]
   \centering
   \caption{Emissionsenergien und zugehörige Emissionswahrscheinlichen von \ce{^{152}Eu} sowie Peakinhalte und Vollenergienachweiswahrscheinlichkeit.}
