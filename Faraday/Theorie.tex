...
\end{figure} \noindent
Es wird deutlich, dass bei einem Isolator, der auf der linken Seite abgebildet ist, ein Abstand zwischen
...
Bei einem Halbleiter, wie es auch Gallium-Arsenid (\ce{GaAs}) ist, liegt ebenfalls eine Bandlücke vor. Diese ist, im Vergleich
...
\end{equation}
definiert werden.
Eine solche Näherung ist gerade für \ce{GaAs} sinnvoll, da das Leitungsband für kleine $k$ fast exakt harmonisch ist.
...
Durch die Symmetrie von \ce{GaAs} ist die effektive Masse jedoch in alle Raumrichtungen gleich.
Ein Ausschnitt der Bandstruktur von \ce{GaAs} ist in Abbildung \ref{fig:Band_GaAs} abgebildet.
