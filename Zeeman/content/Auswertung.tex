...
\begin{table}[H]
 ...
 Wellenlängenverschiebungen, die mit Formel \eqref{eqn:WV} berechnet werden, aufgeführt.
 \begin{table}[H]
    \centering
...
\begin{table}[H]
  ...
  \end{tabular}
 \end{table} \noindent
 Dabei berechnet sich die Unsicherheit auf das Magnetfeld nach Gaußscher Fehlerfortpflanzung mit
 \begin{equation}
